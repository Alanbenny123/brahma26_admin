...
export default function DataExamplePage() {
    ...
    const loadUsers = async () => {
        ...
        try {
            ...
            if (result.success) {
                setUsers(result.users.slice(0, 5)); // Show first 5
    ...
    const loadTickets = async () => {
        ...
        try {
            ...
            if (result.success) {
                setTickets(result.tickets.slice(0, 5));
                ...
                <CardHeader>
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            ...
                            <CardTitle className="text-xl text-white/90">Users</CardTitle>
                        </div>
                        <div className="flex items-center gap-2">
                            {getSourceBadge(userSource)}
                            <Button
                ...
                <CardHeader>
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            ...
                            <CardTitle className="text-xl text-white/90">Events</CardTitle>
                        </div>
                        <div className="flex items-center gap-2">
                            {getSourceBadge(eventSource)}
                            <Button
                ...
                <CardHeader>
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            ...
                            <CardTitle className="text-xl text-white/90">Tickets</CardTitle>
                        </div>
                        <div className="flex items-center gap-2">
                            {getSourceBadge(ticketSource)}
                            <Button
